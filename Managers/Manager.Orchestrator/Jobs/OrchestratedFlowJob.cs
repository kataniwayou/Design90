...
public class OrchestratedFlowJob : IJob
{
        ...
        Guid correlationId)
    {
        ...
        foreach (var entryPoint in entryPoints)
        {
            ...
            try
            {
                ...
                _flowMetricsService.RecordEventPublished(success: true, orchestratedFlowId, entryPoint, executionId, Guid.Empty);
            ...
            catch (Exception ex)
            {
                ...
                _flowMetricsService.RecordEventPublished(success: false, orchestratedFlowId, entryPoint, executionId, Guid.Empty);
    ...
    private async Task HandleOneTimeExecutionAsync(Guid orchestratedFlowId, OrchestratedFlowEntity orchestratedFlow)
    {
        try
        {
